                                        ...
                                        <div class="row">
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{asset('assets/images/work-img1.jpg')}} "alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{asset('assets/images/work-img1.jpg')}} " class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{asset('assets/images/work-img2.jpg')}}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{asset('assets/images/work-img2.jpg')}} " class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{asset('assets/images/work-img3.jpg')}}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{asset('assets/images/work-img3.jpg')}} " class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="port_item xs-m-top-30">
                                                    <div class="port_img">
                                                        <img src="{{asset('assets/images/work-img4.jpg')}}" alt="" />
                                                        <div class="port_overlay text-center">
                                                            <a href="{{asset('assets/images/work-img4.jpg')}} " class="popup-img">+</a>
                                                        </div>
                                                    </div>
                                                    <div class="port_caption m-top-20">
                                                        <h5>Your Work Title</h5>
